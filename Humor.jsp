<%-- 
    Document   : dbms36
    Created on : 2 Nov, 2018, 6:28:17 PM
    Author     : naman
--%>
...
table#t1 {
    ...
    <body>
        ...
        <%
            String b,c,d,cat="Humor";
            session.setAttribute("cat1",cat);
        int f;
        int a,e,g;
        %>
        <IMG STYLE="position:absolute; TOP:150px; LEFT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/hum-1.jpg">
        <IMG STYLE="position:absolute; TOP:500px; LEFT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/hum-2.jpg">
        <IMG STYLE="position:absolute; TOP:50px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/hum-3.jpg">
        <IMG STYLE="position:absolute; TOP:300px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/hum4.jpg">
        <IMG STYLE="position:absolute; TOP:550px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/hum-5.jpg">
        ...
        <font face="ink free" color="black" size="6">The Humor Books Available Are:</font></h1><br></div>
        ...
        try{
            Class.forName("oracle.jdbc.driver.OracleDriver");
              ...
              st = conn.createStatement();
               String sql="select * from books where genreid=6";
