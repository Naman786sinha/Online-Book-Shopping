<%-- 
    Document   : dbms32
    Created on : 2 Nov, 2018, 6:26:06 PM
    Author     : naman
--%>
...
table#t1 {
    ...
    <body>
        ...
        <%
            String b,c,d,cat="Science-Fiction";
            session.setAttribute("cat1",cat);
        int f;
        int a,e,g;
        %>
        <IMG STYLE="position:absolute; TOP:150px; LEFT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Sci-1.jpg">
        <IMG STYLE="position:absolute; TOP:500px; LEFT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Sci-2.jpeg">
        <IMG STYLE="position:absolute; TOP:50px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Sci-3.jpeg">
        <IMG STYLE="position:absolute; TOP:300px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Sci-4.jpg">
        <IMG STYLE="position:absolute; TOP:550px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Sci-5.png">
        ...
        <font face="ink free" color="black" size="6">The Science-Fiction Books Available Are:</font></h1><br></div>
        ...
        try{
            Class.forName("oracle.jdbc.driver.OracleDriver");
              ...
              st = conn.createStatement();
               String sql="select * from books where genreid=2";
