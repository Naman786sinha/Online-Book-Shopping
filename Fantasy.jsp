<%-- 
    Document   : dbms34
    Created on : 2 Nov, 2018, 6:27:35 PM
    Author     : naman
--%>
...
table#t1 {
    ...
    <body>
        ...
        <%
            String b,c,d,cat="Fantasy";
            session.setAttribute("cat1",cat);
        int f;
        int a,e,g;
        %>
        <IMG STYLE="position:absolute; TOP:150px; LEFT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Fan-1.jpg">
        <IMG STYLE="position:absolute; TOP:500px; LEFT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Fan-2.jpg">
        <IMG STYLE="position:absolute; TOP:50px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Fan-3.jpg">
        <IMG STYLE="position:absolute; TOP:300px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Fan-4.jpg">
        <IMG STYLE="position:absolute; TOP:550px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Fan-5.jpg">
        ...
        <font face="ink free" color="black" size="6">The Fantasy Books Available Are:</font><br></div>
        <table border="5" cellspacing="7" cellpadding="7" id="t1">
            ...
            <thead>
                <tr><th><font face="ink free"  size="4">Title</th>
                    ...
                    <th><font face="ink free"  size="4">Quantity in Stock</t>
        ...
        try{
            Class.forName("oracle.jdbc.driver.OracleDriver");
              ...
              st = conn.createStatement();
               String sql="select * from books where genreid=4";
