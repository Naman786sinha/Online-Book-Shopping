<%-- 
    Document   : dbms3
    Created on : 2 Oct, 2018, 12:32:29 PM
    Author     : naman
--%>
...
table#t1 {
    ...
    border-radius: 12px;
            ...
            body,html{
                height: 100%;
                background:linear-gradient(to bottom, #ffcc99 10%, #66ccff 90%);
    ...
    <body>
        ...
        <%
            String b,c,d,cat="Adventure";
            session.setAttribute("cat1",cat);
        int f;
        int a,e,g;
        %>
        <IMG STYLE="position:absolute; TOP:150px; LEFT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Adv-1.jpg">
        <IMG STYLE="position:absolute; TOP:500px; LEFT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Adv-2.jpg">
        <IMG STYLE="position:absolute; TOP:50px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Adv-3.jpg">
        <IMG STYLE="position:absolute; TOP:300px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Adv-4.jpg">
        <IMG STYLE="position:absolute; TOP:550px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/Adv-5.png">
        ...
        <font face="ink free" color="black" size="6">The Adventure Books Available Are:</font></h1></div><br>
        ...
        try{
            Class.forName("oracle.jdbc.driver.OracleDriver");
              ...
              st = conn.createStatement();
               String sql="select * from books where genreid=1";
       ...
       <tbody>
               <tr>
                   <td><font face="ink free"  size="4"><%=d%></td>
                   <td><font face="ink free"  size="4"><%=b%></td>
                   <td><font face="ink free"  size="4"><%=c%></td>
                   <td><font face="ink free"  size="4"><%=f%></td>
                   <td><font face="ink free"  size="4"><%=g%></td>
