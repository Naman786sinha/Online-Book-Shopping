<%-- 
    Document   : dbms35
    Created on : 2 Nov, 2018, 6:28:00 PM
    Author     : naman
--%>
...
table#t1 {
    ...
    <body>
        ...
        <%
            String b,c,d,cat="Horror";
            session.setAttribute("cat1",cat);
        int f;
        int a,e,g;
        %>
        <IMG STYLE="position:absolute; TOP:150px; LEFT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/hor-1.jpg">
        <IMG STYLE="position:absolute; TOP:500px; LEFT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/hor-2.jpg">
        <IMG STYLE="position:absolute; TOP:50px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/hor-3.jpg">
        <IMG STYLE="position:absolute; TOP:300px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/hor-4.jpg">
        <IMG STYLE="position:absolute; TOP:550px; RIGHT:20px; WIDTH:190px; HEIGHT:220px" SRC="images/hor-5.jpg">
       <div><p><center><font face="comic sans ms" size="4" color="lime">Congrats! You are a part of the World's most reliable shopping site!</font></center></p> 
        ...
        <font face="ink free" color="black" size="6">The Horror Books Available Are:</font></h1><br></div>
        ...
        try{
            Class.forName("oracle.jdbc.driver.OracleDriver");
              ...
              st = conn.createStatement();
               String sql="select * from books where genreid=5";
